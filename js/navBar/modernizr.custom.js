 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-hsla-multiplebgs-opacity-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-applicationcache-canvas-canvastext-draganddrop-hashchange-history-audio-video-indexeddb-input-inputtypes-localstorage-postmessage-sessionstorage-websockets-websqldatabase-webworkers-geolocation-inlinesvg-smil-svg-svgclippaths-touch-webgl-shiv-cssclasses-addtest-prefixed-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-a_download-canvas_todataurl_type-cookies-cors-css_overflow_scrolling-css_scrollbars-fullscreen_api-load
 */
;
window.Modernizr = function(a, b, c) {
    ...
    }, Modernizr.addTest("adownload", "download" in document.createElement("a")), Modernizr.addTest("cssscrollbar", function() {
    ...
    function() {
        ...
        }, a.src = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAACklEQVR4nGMAAQAABQABDQottAAAAABJRU5ErkJggg=="
    }(), Modernizr.addTest("cors", !!(window.XMLHttpRequest && "withCredentials" in new XMLHttpRequest)), Modernizr.addTest("overflowscrolling", function() {
...
Modernizr.addTest('nintendo', function() {

    var html = document.getElementsByTagName('html')[0],
        classes = html.className.split(' '),
        nintendoDevice = false,
        platform = navigator.platform.toLowerCase(),
        platforms = ['nintendo', 'ds', 'dsi', '3ds', 'wii', 'wiiu'],
        i = 0,
        l = platforms.length;
